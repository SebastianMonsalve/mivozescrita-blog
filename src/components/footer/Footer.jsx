  ...
  return (
    <footer className="footer">
      <div className="footer-container1">
        <div className="footer-container1-logo">
          <svg
...
24 0 361 0 361 -25 24 c-15 16 -36 25 -55 25 -19 0 -40 -9 -55 -25z"
        ...
        <div className="footer-container1-info">
          <span>Mi Voz Escrita.</span>
          <p>© 2024 Mi Voz Escrita.</p>
          {!admin ? (
            <Link to="/adminlogin" className="footer-container1-info-link">
      ...
      <div className="footer-container2">
        ...
        <a href="https://www.instagram.com/mi_voz_escrita" target="_blank">
          <i className="fa-brands fa-instagram" />
          Instagram Oficial
        </a>
        <a href="https://www.instagram.com/alejahb_29" target="_blank">
          <i className="fa-brands fa-instagram" />
          Instagram Personal
        </a>
      </div>
      <div className="footer-container3">
        <h3>Creado por:</h3>
        <a href="https://sebastianmonsalve.netlify.app/" target="_blank">
